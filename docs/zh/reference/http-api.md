...
实现入口：[路由装配](https://github.com/lilhammerfun/clumsies/blob/main/crates/server/src/routes.rs)、[前置条件与错误](https://github.com/lilhammerfun/clumsies/blob/main/crates/server/src/http.rs)、[Draft/Review 请求响应](https://github.com/lilhammerfun/clumsies/blob/main/crates/server/src/app/draft/dto.rs), [Review DTO](https://github.com/lilhammerfun/clumsies/blob/main/crates/server/src/app/review/dto.rs)、[Review 事务](https://github.com/lilhammerfun/clumsies/blob/main/crates/server/src/app/review/repository.rs)、[Memory handler](https://github.com/lilhammerfun/clumsies/blob/main/crates/server/src/app/memory/handler.rs)、[Admin 分页](https://github.com/lilhammerfun/clumsies/blob/main/crates/server/src/pagination.rs)。
